...
"[project]/src/app/expense/new/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>CreateTripExpense)
});
...
function CreateTripExpense() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateTripExpense.useEffect": ()=>{
            if (editId) {
                // @ts-ignore
                mockFetchExpenseData(editId).then({
                    "CreateTripExpense.useEffect": (response)=>{
                ...
                }["CreateTripExpense.useEffect"]).catch({
                    "CreateTripExpense.useEffect": (err)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateTripExpense.useEffect": ()=>{
            if (!editId) {
                ...
                setFormData({
                    "CreateTripExpense.useEffect": (prev)=>({
                            ...prev,
                            date: formattedDate
                        })
                }["CreateTripExpense.useEffect"]);
        ...
        "CreateTripExpense.useEffect": ()=>{
            if (toastMessage) {
                const timer = setTimeout({
                    "CreateTripExpense.useEffect.timer": ()=>{
                        setToastMessage(null);
                    }
                }["CreateTripExpense.useEffect.timer"], 3000);
                return ({
                    "CreateTripExpense.useEffect": ()=>clearTimeout(timer)
                })["CreateTripExpense.useEffect"];
            }
        }
    }["CreateTripExpense.useEffect"], [
    ...
    const handlePaymentTypeClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[handlePaymentTypeClick]": (type)=>{
            setFormData({
                "CreateTripExpense.useCallback[handlePaymentTypeClick]": (prev)=>({
                        ...prev,
                        paymentType: type
                    })
            }["CreateTripExpense.useCallback[handlePaymentTypeClick]"]);
            setErrors({
                "CreateTripExpense.useCallback[handlePaymentTypeClick]": (prev)=>({
                        ...prev,
                        paymentType: null
    ...
    const handleAttachment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[handleAttachment]": (fileName)=>{
            setFormData({
                "CreateTripExpense.useCallback[handleAttachment]": (prev)=>({
                        ...prev,
                        attachment: fileName
                    })
            }["CreateTripExpense.useCallback[handleAttachment]"]);
            setErrors({
                "CreateTripExpense.useCallback[handleAttachment]": (prev)=>({
                        ...prev,
                        attachment: null
    ...
    const handleBackButtonClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[handleBackButtonClick]": ()=>{
            setEditId(null);
        }
    }["CreateTripExpense.useCallback[handleBackButtonClick]"], []);
    const openCategoryOffcanvas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[openCategoryOffcanvas]": ()=>{
    ...
    const closeCategoryOffcanvas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[closeCategoryOffcanvas]": ()=>{
    ...
    const handleCategorySelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[handleCategorySelect]": (category)=>{
            setFormData({
                "CreateTripExpense.useCallback[handleCategorySelect]": (prev)=>({
                        ...prev,
                        category
                    })
            }["CreateTripExpense.useCallback[handleCategorySelect]"]);
            setErrors({
                "CreateTripExpense.useCallback[handleCategorySelect]": (prev)=>({
                        ...prev,
                        category: null
    ...
    const resetForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[resetForm]": ()=>{
            setFormData({
                date: "",
                category: "",
                description: "",
            ...
            setCategorySearchQuery("");
            setFormKey({
                "CreateTripExpense.useCallback[resetForm]": (prevKey)=>prevKey + 1
            }["CreateTripExpense.useCallback[resetForm]"]);
        }
    }["CreateTripExpense.useCallback[resetForm]"], []);
    const handleCreateTripExpense = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CreateTripExpense.useCallback[handleCreateTripExpense]": async ()=>{
            let newErrors = {};
            let isValid = true;
            // Validation logic
            if (!formData.date) {
    ...
    }["CreateTripExpense.useCallback[handleCreateTripExpense]"], [
        formData,
        editId,
        resetForm
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    errors.date && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormError, {
                                        message: errors.date
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/expense/new/page.tsx",
                                        lineNumber: 301,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    errors.category && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormError, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    errors.amount && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormError, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    errors.paymentType && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormError, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            errors.attachment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormError, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: filteredCategories.length > 0 ? filteredCategories.map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            toastMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ToastMessage, {
...
_s(CreateTripExpense, "1Fp/D5PuwHxieOtP3ikwZA66018=");
_c2 = CreateTripExpense;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "ToastMessage");
__turbopack_context__.k.register(_c1, "FormError");
__turbopack_context__.k.register(_c2, "CreateTripExpense");
...
//# sourceMappingURL=_2b72faf6._.js.map